---
title: "Trends of international student admission in NCKU"
author: "Brian"
date: "6/24/2021"
...
We analyzed data of 'admitted' international students in 2021(n=468) to discover trends in higher education in Taiwan. (work in progress)

<!-- #### Import data -->

```{r}
prefix <- "NCKU"
dataset <- read.xlsx("NCKU_2021.xlsx","Sheet1",header=TRUE)
dataset <- dataset %>%
  mutate(College = str_remove(College,"College of ")) %>%
  mutate(Department = str_remove(Department,"Department of |Inst. of "))
```
